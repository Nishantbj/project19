...
var coinGroup;
var boyJumpSound, checkPointSound, coinSound, gameOverSound;
...
function preload(){
  ...
  boyJumpSound = loadSound("boyJumpSound.mp3");
...
function draw() {;
  ...
  if (gameState===PLAY){
    ...
    if(score>0 && score%175 === 0){
      checkPointSound.play() 

   }

   if(coinGroup.overlap(boy)){
    coinSound.play();
